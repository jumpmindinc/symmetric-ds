...
public class SnapshotUtilTest {
    ...
    void testAddUsableDiskSpaceProperties() {
        ...
        assertEquals("1.00 GB", properties.getProperty("log.directory.space.usable"));
        assertEquals("1.00 MB", properties.getProperty("staging.directory.space.usable"));
        assertEquals("512 B", properties.getProperty("temp.directory.space.usable"));
    }
}
