...
public class ServerConstants {
    ...
    public static final String CLUSTER_PEER_DISCOVERY = "cluster.peer.discovery";
    public static final String CLUSTER_PEER_DISCOVERY_DB = "db";
    public static final String CLUSTER_PEER_DISCOVERY_SERVERS = "cluster.peer.discovery.static.servers";
    ...
    public static final Map<String, String> JVM_IMPORT_ENV_VARS = Map.ofEntries(
            ...
            entry("SYM_CLUSTER_LOCK_ENABLED", ParameterConstants.CLUSTER_LOCKING_ENABLED),
