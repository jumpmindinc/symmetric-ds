...
public class TableConstants {
    ...
    public static final String METRIC_SERIES = "metric_series";
    ...
    public static final Set<String> getTables(String tablePrefix) {
        ...
        addPrefixToTableNames(tables, tablePrefix, SYM_CHANNEL, SYM_CONFLICT, SYM_CONTEXT, SYM_DATA, SYM_DATA_GAP, SYM_DATA_EVENT, SYM_EXTRACT_REQUEST,
                ...
                METRIC_KEY, METRIC_STATS_FLOAT64, METRIC_STATS_INT64, METRIC_SERIES, METRIC_CONTEXT);
        if (hasConsoleSchema) {
    ...
    public static final List<String> getConfigTables(String tablePrefix) {
        ...
        addPrefixToTableNames(tables, tablePrefix, SYM_NODE_GROUP, SYM_NODE_GROUP_LINK, SYM_NODE, SYM_NODE_HOST, SYM_NODE_IDENTITY, SYM_NODE_SECURITY,
                SYM_PARAMETER, SYM_CHANNEL, SYM_NODE_GROUP_CHANNEL_WND, SYM_NODE_CHANNEL_CTL, SYM_TRIGGER, SYM_ROUTER, SYM_TRIGGER_ROUTER, SYM_TRANSFORM_TABLE,
                SYM_LOAD_FILTER, SYM_TRANSFORM_COLUMN, SYM_CONFLICT, SYM_GROUPLET, SYM_GROUPLET_LINK, SYM_TRIGGER_ROUTER_GROUPLET, SYM_FILE_TRIGGER,
                SYM_FILE_TRIGGER_ROUTER, SYM_FILE_SNAPSHOT, SYM_EXTENSION, SYM_JOB, SYM_TABLE_RELOAD_REQUEST, SYM_TABLE_RELOAD_STATUS,
