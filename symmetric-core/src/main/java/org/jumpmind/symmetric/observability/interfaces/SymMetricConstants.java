...
public final class SymMetricConstants {
    ...
    public static final String METRIC_UNIT_PERCENT = "%";
    public static final String METRIC_UNIT_CONNECTIONS = "{connection}";
    public static final String METRIC_UNIT_BYTES = "By";
    public static final String METRIC_UNIT_MB = "MiBy";
    public static final String METRIC_UNIT_MILLIS = "ms";
    public static final String METRIC_UNIT_SECONDS = "s";
    public static final String METRIC_UNIT_MINUTES = "min";
    public static final String METRIC_UNIT_HOURS = "h";
    public static final String METRIC_UNIT_DAYS = "d";
    public static final String METRIC_UNIT_MONTHS = "mo";
    public static final String METRIC_UNIT_BATCHES = "{batch}";
    public static final String METRIC_UNIT_ROWS = "{row}";
    public static final String METRIC_UNIT_NODES = "{node}";
    public static final String METRIC_UNIT_TRIGGERS = "{trigger}";
    public static final String METRIC_UNIT_RESTARTS = "{restart}";
