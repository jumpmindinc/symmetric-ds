...
public interface IExtractDataReaderFactory {
    public ExtractDataReader getReader(IDatabasePlatform platform, IExtractDataReaderSource source,
            Node sourceNode, Node targetNode, IDatabasePlatform targetPlatform);
}
