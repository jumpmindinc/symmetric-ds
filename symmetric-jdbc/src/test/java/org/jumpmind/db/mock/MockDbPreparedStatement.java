...
public class MockDbPreparedStatement implements PreparedStatement {
    ...
    @Override
    @SuppressWarnings("deprecation") // warning: [deprecation] setUnicodeStream(int,InputStream,int) in PreparedStatement has been deprecated
    @Deprecated
    public void setUnicodeStream(int parameterIndex, InputStream x, int length) throws SQLException {
        throw new UnsupportedOperationException("Parent PreparedStatement had deprecated the setUnicodeStream method");
    }
}
